<?php
// /app/Nov_16/budget_c_v3.php
// Versão 3 com correções de cálculo e UX
                    ...
                    switch ($service) {
                        case 'Tradução':
                            ...
                            $costBreakdown[] = [
                                ...
                                'service' => $service,
                                'calculation' => "$unitCost × $weightedSum palavras ponderadas",
                                'total' => $totalCost
                            ];
                            break;
                        ...
                        case 'Revisão':
                            ...
                            $costBreakdown[] = [
                                'provider' => $item['provider_name'],
                                'service' => $service,
                                'calculation' => "$unitCost × $totalWords palavras",
                                'total' => $totalCost
                            ];
                            break;
                        ...
                        case 'Diagramação':
                            ...
                            $costBreakdown[] = [
                                'provider' => $item['provider_name'],
                                'service' => $service,
                                'calculation' => "$unitCost × $totalPages páginas",
                                'total' => $totalCost
                            ];
                            break;
    ...
    <div class="cards-grid-2col">
        ...
        <div class="video-card <?= $currentStep < 3 ? 'disabled' : '' ?> <?= $currentStep > 3 ? 'completed' : '' ?>" id="cardArquivos">
            ...
            <form id="formArquivos" class="vision-form-refined" enctype="multipart/form-data">
                ...
                <!-- Lista de arquivos já adicionados (da sessão) -->
