<?php
// /app/Nov_16/budget_c_v2.php
// Versão atualizada com fluxo sem reload

session_start();

// Autoload do Composer
require_once __DIR__ . '/../v/vendor/autoload.php';
    ...
    try {
        switch ($action) {
            ...
            case 'calculate_budget':
                ...
                $custoTotal = array_sum(array_column($_SESSION['budget_costs']['items'], 'cost'));
...
// Upload de arquivos (processamento normal)
...
include __DIR__ . '/../v/vision/includes/head.php';
include __DIR__ . '/../v/vision/includes/header.php';
include __DIR__ . '/../v/vision/includes/sidebar.php';
?>
...
.alert-success { background: #22c55e; color: #fff; padding: 15px 30px; border-radius: 12px; margin-bottom: 20px; }
...
<div class="main-content">
    ...
    <div class="cards-grid-2col">
        ...
        <div class="video-card <?= $currentStep < 4 ? 'disabled' : '' ?> <?= $currentStep > 4 ? 'completed' : '' ?>" id="cardCustos">
            ...
            <div class="form-actions" id="costsBtnContainer" style="<?= empty($budgetCosts['items']) ? 'display:none;' : '' ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (formCliente) {
        formCliente.addEventListener('submit', function(e) {
            ...
            .catch(err => showAlert('Erro ao processar: ' + err, 'error'));
        });
    }
    ...
    if (formArquivos) {
        formArquivos.addEventListener('submit', function(e) {
            ...
            .catch(err => {
                ...
                progressContainer.style.display = 'none';
                btnCalcFuzzy.disabled = false;
                showAlert('Erro ao processar: ' + err, 'error');
            });
        });
    }
    ...
    if (formCusto) {
        formCusto.addEventListener('submit', function(e) {
            ...
            .catch(err => showAlert('Erro ao adicionar custo: ' + err, 'error'));
        });
    }
    ...
    function removeCost(index, rowElement) {
        ...
        .catch(err => showAlert('Erro: ' + err, 'error'));
    }
    ...
    if (btnCalculateBudget) {
        btnCalculateBudget.addEventListener('click', function() {
            ...
            .catch(err => showAlert('Erro ao calcular: ' + err, 'error'));
        });
    }
...
<?php
include __DIR__ . '/../v/vision/includes/footer.php';
?>