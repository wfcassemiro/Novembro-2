<?php
// /app/Nov_16/budget_c_v5.php
// Versão 5 - Correções finais de UX e modal de cliente
...
// Estado de Markup e Impostos MOVIDO para custos
...
/* Header com ícone centralizado - ESTILO DO PROJECTS.PHP */
.profile-header-card {
    ...
    <div class="cards-grid-2col">
        ...
        <div class="video-card <?= $currentStep < 4 ? 'disabled' : '' ?> <?= $currentStep > 4 ? 'completed' : '' ?>" id="cardCustos">
            ...
            <form id="formCusto" class="vision-form-refined" style="padding-top: 15px; border-top: 1px solid rgba(255, 255, 255, 0.06);">
                ...
                <!-- MARKUP E IMPOSTOS MOVIDOS PARA CÁ -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // File Input - CORREÇÃO: ACUMULAR ARQUIVOS
    if (fileInput) {
...
document.addEventListener("keydown", function(e) {
    if (e.key === "Escape") hideAddClientModal();
});
